...
class quiz:
    ...
    def __init__(self, active_quiz):
        ...
        self.frame_result=Frame(root,bd=5, highlightbackground="black", highlightthickness=2, bg="gray")
    ...
    def question(self, q_number):
        q_number = Label(self.frame_p, text=self.questions[q_number][0], width=55, font=("times", 16, "bold"), anchor="w", bg="gray")
        q_number.place(x=10, y=10)
        return q_number
    def radiobtns(self):
        val = 0
        B = []
