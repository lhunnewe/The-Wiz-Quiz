...
class menu:
    def __init__(self):
        ...
        self.pf_listbox.place(relx=0,rely=0.0,relwidth=1.0,relheight=1.0)
...
class quiz:
    ...
    def __init__(self, active_quiz):
        ...
        self.frame_p.place(relx=0.05,rely=0.05,relwidth=0.90,relheight=.90)

        self.frame_result=Frame(root,bd=5)
        self.frame_result.place(relx=0.05,rely=0.05,relwidth=0.90,relheight=.75)

        self.frame_p.tkraise()
    ...
    def question(self, q_number):
        ...
        qn = Label(self.frame_p, text=self.questions[q_number][0], width=60, font=("times", 16, "bold"), anchor="w")
        qn.place(x=70, y=100)
        return qn
    def radiobtns(self):
        val = 0
    ...
    def display_options(self, q_number):
        ...
        for choice in choices[0]:
            ...
            val +=1
    def buttons(self):
        nbutton = Button(self.frame_p, text="Next",command=self.nextbtn, width=10,bg="green",fg="white",font=("times",16,"bold"))
        ...
        quitbutton = Button(self.frame_p, text="Quit", command=self.display_result,width=10,bg="red",fg="white", font=("times",16,"bold"))
        quitbutton.place(x=380,y=380)
